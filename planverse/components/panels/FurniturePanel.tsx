  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
      <div className="bg-gradient-to-r from-slate-700 to-slate-800 px-4 py-3">
        ...
        <p className="text-slate-300 text-xs mt-0.5">Click to add to canvas</p>
      </div>
      ...
      <div className="p-3 grid grid-cols-2 gap-2 max-h-[500px] overflow-y-auto">
        {FURNITURE_CATALOG.map((item) => (
          <button
            ...
            className="flex flex-col items-center gap-1 p-3 rounded-lg border border-gray-100 bg-gray-50 hover:bg-blue-50 hover:border-blue-200 transition-all group cursor-pointer"
          >
